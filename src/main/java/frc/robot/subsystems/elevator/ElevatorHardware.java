...
public class ElevatorHardware implements ElevatorIO {
        ...
        public static final class ElevatorHardwareConstants {
                ...
                private static final Voltage ARBITRARY_FF_GRAVITY_COMPENSATION = Volts.of(0.28); // calculated using
                                                                                                 // recalc
        ...
        public ElevatorHardware() {
                ...
                elevatorRightMotorFollower = new SparkFlex(MotorIdConstants.RIGHT_ELEVATOR_MOTOR_ID,
                ...
                globalMotorConfig.encoder
                                ...
                                .velocityConversionFactor(
                                                ElevatorHardwareConstants.METERS_PER_REVOLUTION.in(Meters) / 60);
                ...
                globalMotorConfig.closedLoop
                                ...
                                .velocityFF(ElevatorHardwareConstants.FEEDFORWARD_VALUE.in(Volts),
                                                ClosedLoopSlot.kSlot1)
                                .outputRange(ElevatorHardwareConstants.OUTPUT_RANGE_MIN_VALUE,
                                                ElevatorHardwareConstants.OUTPUT_RANGE_MAX_VALUE,
                                                ClosedLoopSlot.kSlot1);

                globalMotorConfig.softLimit
                                .forwardSoftLimit((ElevatorHardwareConstants.MAX_ELEVATOR_HEIGHT).in(Meters) - 0.02) // a
                                                                                                                     // little
                                                                                                                     // less
                                                                                                                     // than
                                                                                                                     // max
