...
public class ReefscapeVisionUtil {
        ...
        private static final Transform2d REEF_TO_ROBOT = new Transform2d(Inches.of(29.5), Inches.zero(),
                        Rotation2d.k180deg);
        private static final Transform2d SCORING_POSE_OFFSET_LEFT = new Transform2d(Inches.zero(), Inches.of(8),
                        Rotation2d.kZero);
        private static final Transform2d SCORING_POSE_OFFSET_RIGHT = new Transform2d(Inches.zero(), Inches.of(-6),
                        Rotation2d.kZero);
