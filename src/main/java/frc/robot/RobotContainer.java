...
public class RobotContainer {
  ...
  private void setUpAuton() {
    ...
    NamedCommands.registerCommand("Elevator to L1 setpoint",
        elevator.goToGoalSetpointCmd(SetpointConstants.L_ONE_HEIGHT).andThen(elevator.atGoalCommand()));
    NamedCommands.registerCommand("Elevator to L2 setpoint",
        elevator.goToGoalSetpointCmd(SetpointConstants.L_TWO_HEIGHT).andThen(elevator.atGoalCommand()));
    NamedCommands.registerCommand("Elevator to L3 setpoint",
        elevator.goToGoalSetpointCmd(SetpointConstants.L_THREE_HEIGHT).andThen(elevator.atGoalCommand()));
    NamedCommands.registerCommand("Elevator to L4 setpoint",
        elevator.goToGoalSetpointCmd(SetpointConstants.L_FOUR_HEIGHT).andThen(elevator.atGoalCommand()));
    NamedCommands.registerCommand("Coral wrist to L1 setpoint",
        coralWrist.goToSetpointCommand(SetpointConstants.CORAL_L1_ANGLE).withTimeout(1));
    NamedCommands.registerCommand("Coral wrist to L2 setpoint",
        coralWrist.goToSetpointCommand(SetpointConstants.CORAL_OUTTAKE_ANGLE));
  ...
  private void configureButtonBindingsOperator() {
    ...
    operatorController.leftBumper().onTrue(coralWrist.goToSetpointCommand(SetpointConstants.CORAL_L1_ANGLE)
