...
public class RobotContainer {
        ...
        public void configureDefaultCommands() {
                ...
                coralIntake.setDefaultCommand(coralIntake.setRollerSpeed(RPM.of(0)).withName("coral Intake default"));
                coralWrist.setDefaultCommand(coralWrist.setWristSpeed(RPM.of(0)).withName("coral Wrist default"));
