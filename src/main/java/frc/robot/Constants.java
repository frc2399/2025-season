...
public final class Constants {
  ...
  public static class SpeedConstants {
    ...
    public static final AngularVelocity ALPHA_ALGAE_INTAKE_SPEED = MotorConstants.NEO550_FREE_SPEED.times(0.75);
    public static final AngularVelocity ALPHA_ALGAE_OUTTAKE_SPEED = MotorConstants.NEO550_FREE_SPEED.times(-0.50);
  ...
  public static class SetpointConstants {
    ...
    public static final Angle CORAL_L1_ANGLE = Degrees.of(-90);
    ...
    public static final Distance L_TWO_CORAL_HEIGHT = Inches.of(8.5);
    public static final Distance L_THREE_CORAL_HEIGHT = Inches.of(24);
