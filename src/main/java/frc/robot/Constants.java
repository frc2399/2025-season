...
public final class Constants {
  ...
  public static class SpeedConstants {
    ...
    public static final AngularVelocity ALPHA_CORAL_PASSIVE_SPEED = MotorConstants.NEO550_FREE_SPEED.times(0.05);
    ...
    public static final AngularVelocity BETA_ALGAE_PASSIVE_SPEED = MotorConstants.NEO550_FREE_SPEED.times(0.05);
